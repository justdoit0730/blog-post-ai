...
public class EtcPageController {
    ...
    public String supportTemplatePage() {
        return "support/support-template";
    }
    ...
    public String communityNoticePage(Model model, @RequestParam(value = "page", defaultValue = "1") int page) {
        int pageSize = 10;
