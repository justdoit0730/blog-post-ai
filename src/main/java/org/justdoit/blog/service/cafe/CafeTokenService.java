...
//        }
//        return refreshAccessTokenManager(user, sessionUser);
//    }
...
//    }
    ...
    public String refreshAccessToken(ManagerInfo managerInfo) throws IOException {
    ...
    @Transactional
    public void validationCountPlus(ManagerInfo managerInfo, int validationCount) {
